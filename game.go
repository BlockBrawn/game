...
func NewGame(settings *settings.Settings, teams []*team.Team, states []state.State, playerHandler handler_custom.JoinHandler, worldHandler world.Handler, invHandler inventory.Handler) *Game {
